...
namespace UorAddr1.KappaDerivation

open UorAddr1.HexEncoding
open UorAddr1.AddressShape
...
theorem distinct_digests_yield_distinct_labels
  ...
  have heq : encodeByte (d₁ k) = encodeByte (d₂ k) := by
    rw [← h₁, ← h₂, hk]
  exact UorAddr1.HexEncoding.encode_byte_injective _ _ heq

end UorAddr1.KappaDerivation
