//! ASN.1 realization's `ResolverTuple` — the eight ψ-stage
...
//! [`crate::asn1::Asn1Value`] inside its resolver body (ADR-046
...
use crate::asn1::shapes::bounds::{Asn1AddrBounds, ASN1_VALUE_MAX_BYTES};
...
const CARRIER_BYTES: usize = <Asn1AddrBounds as HostBounds>::TERM_VALUE_MAX_BYTES;
...
const _: () = {
    assert!(
        ASN1_VALUE_MAX_BYTES <= CARRIER_PAYLOAD_MAX,
        "ASN1_VALUE_MAX_BYTES must fit within CARRIER_BYTES - LENGTH_PREFIX_BYTES - GEOMETRY_TAIL_BYTES"
    );
};
...
const INPUT_LEN_VIOLATION: ShapeViolation = ShapeViolation {
    shape_iri: "https://uor.foundation/addr/asn1/resolver/Asn1ValueBytes",
    constraint_iri: "https://uor.foundation/addr/asn1/resolver/Asn1ValueBytes/maxBytes",
    property_iri: "https://uor.foundation/addr/asn1/resolver/Asn1ValueBytes/byteCount",
...
const CARRIER_INPUT_VIOLATION: ShapeViolation = ShapeViolation {
    shape_iri: "https://uor.foundation/addr/asn1/resolver/CarrierInput",
    constraint_iri: "https://uor.foundation/addr/asn1/resolver/CarrierInput/expectedCarrierBytes",
    property_iri: "https://uor.foundation/addr/asn1/resolver/CarrierInput/byteCount",
...
const CARRIER_BUFFER_VIOLATION: ShapeViolation = ShapeViolation {
    shape_iri: "https://uor.foundation/addr/asn1/resolver/CarrierBuffer",
    constraint_iri: "https://uor.foundation/addr/asn1/resolver/CarrierBuffer/minBytes",
    property_iri: "https://uor.foundation/addr/asn1/resolver/CarrierBuffer/byteCount",
    expected_range: "http://www.w3.org/2001/XMLSchema#nonNegativeInteger",
    min_count: CARRIER_BYTES as u32,
    max_count: 0,
    kind: ViolationKind::ValueCheck,
...
const ADDR_OUTPUT_VIOLATION: ShapeViolation = ShapeViolation {
    shape_iri: "https://uor.foundation/addr/asn1/resolver/AddressLabelBuffer",
    constraint_iri: "https://uor.foundation/addr/asn1/resolver/AddressLabelBuffer/minBytes",
    property_iri: "https://uor.foundation/addr/asn1/resolver/AddressLabelBuffer/byteCount",
    expected_range: "http://www.w3.org/2001/XMLSchema#nonNegativeInteger",
...
const UPSTREAM_TAG_VIOLATION: ShapeViolation = ShapeViolation {
    shape_iri: "https://uor.foundation/addr/asn1/resolver/UpstreamStageTag",
    constraint_iri: "https://uor.foundation/addr/asn1/resolver/UpstreamStageTag/expectedTag",
    property_iri: "https://uor.foundation/addr/asn1/resolver/UpstreamStageTag/stageTag",
...
const GEOMETRY_VIOLATION: ShapeViolation = ShapeViolation {
    shape_iri: "https://uor.foundation/addr/asn1/resolver/CarrierGeometry",
    constraint_iri:
        "https://uor.foundation/addr/asn1/resolver/CarrierGeometry/seventyOneVerticesDiscrete",
    property_iri: "https://uor.foundation/addr/asn1/resolver/CarrierGeometry/vertexCount",
    expected_range: "http://www.w3.org/2001/XMLSchema#unsignedInt",
...
fn decode_carrier(bytes: &[u8]) -> Result<DecodedCarrier<'_>, ShapeViolation> {
    ...
    if canonical_len > ASN1_VALUE_MAX_BYTES {
...
fn emit_carrier(canonical: &[u8], stage_tag: u64, out: &mut [u8]) -> Result<usize, ShapeViolation> {
    ...
    if canonical.len() > ASN1_VALUE_MAX_BYTES {
        return Err(INPUT_LEN_VIOLATION);
    }
...
impl<H: Hasher> NerveResolver<H> for AddressNerveResolver<H> {
    ...
    fn resolve(&self, input: &[u8], out: &mut [u8]) -> Result<usize, ShapeViolation> {
        if input.len() > ASN1_VALUE_MAX_BYTES {
            return Err(INPUT_LEN_VIOLATION);
        }
...
const _: () = {
    assert!(CARRIER_BYTES <= <Asn1AddrBounds as HostBounds>::NERVE_OUTPUT_BYTES_MAX);
    assert!(CARRIER_BYTES <= <Asn1AddrBounds as HostBounds>::CHAIN_COMPLEX_OUTPUT_BYTES_MAX);
    assert!(CARRIER_BYTES <= <Asn1AddrBounds as HostBounds>::HOMOLOGY_GROUPS_OUTPUT_BYTES_MAX);
    assert!(CARRIER_BYTES <= <Asn1AddrBounds as HostBounds>::COCHAIN_COMPLEX_OUTPUT_BYTES_MAX);
    assert!(CARRIER_BYTES <= <Asn1AddrBounds as HostBounds>::COHOMOLOGY_GROUPS_OUTPUT_BYTES_MAX);
    assert!(CARRIER_BYTES <= <Asn1AddrBounds as HostBounds>::POSTNIKOV_TOWER_OUTPUT_BYTES_MAX);
    assert!(CARRIER_BYTES <= <Asn1AddrBounds as HostBounds>::HOMOTOPY_GROUPS_OUTPUT_BYTES_MAX);
    assert!(
        WIRE_FORMAT_ADDRESS_BYTES <= <Asn1AddrBounds as HostBounds>::K_INVARIANTS_OUTPUT_BYTES_MAX
    );
};
