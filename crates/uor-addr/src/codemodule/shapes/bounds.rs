//! `CodeModuleAddrBounds` — code-module AST realization's
//! `HostBounds` profile.

use prism::vocabulary::HostBounds;

pub const MAX_CODEMODULE_DEPTH: usize = 32;
pub const MAX_CODEMODULE_NAME_BYTES: usize = 256;
pub const MAX_CODEMODULE_ITEMS: usize = 256;
pub const CODEMODULE_VALUE_MAX_BYTES: usize = 3968;

#[derive(Debug, Default, Clone, Copy, PartialEq, Eq, Hash)]
pub struct CodeModuleAddrBounds;

impl HostBounds for CodeModuleAddrBounds {
