...
pub use label::{AddressLabel, ADDRESS_LABEL_BYTES};
...
// `uor_addr::json::*`.
pub use json::{
    address, address_inference, canonicalize, AddrBounds, AddressFailure, AddressModel,
    AddressOutcome, AddressResolverTuple, AddressRoute, AddressWitness, JsonValue,
    JsonValueRegistry, Sha256Hasher, JSON_VALUE_MAX_BYTES, MAX_ARRAY_ELEMENTS, MAX_JSON_DEPTH,
    MAX_NUMBER_DIGITS, MAX_OBJECT_KEYS, MAX_STRING_BYTES, VERB_TERMS_ADDRESS_INFERENCE,
};
